...
Once you have downloaded a dataset, you are ready to use _RRest_. You should specify its location to _RRest_ in the _up.paths.root_folder_ variable, in the _setup_universal_params.m_ script.
